...
The Cobweb module specialized for RSA framework adjusts and adds some features:

When fitting a new instance into a tree, 
Not onlt the counts of some node will be updated, the whole instance will also be stored in the node.
However, when updating the counts of a CobwebNode with the new instance,
only the attributes that is not classification will be fitted into the nodes.
So when calculating the utilities and choosing from the adjustments of the tree,
classifications will always NOT be considered.

To see the corresponding adjustments, see:
-> CobwebNode.__init__()
-> CobwebNode.increment_counts(instance, instance_with_c=None)
-> CobwebNode.create_new_child(instance, instance_with_c=None)
-> CobwebTree.cobweb(instance)
...
from cobweb.utils import weighted_choice
from cobweb.utils import most_likely_choice
...
class CobwebNode(object):
    ...
    def increment_counts(self, instance, instance_with_c=None):
        ...
        :param instance_with_c: The same instance of the new one 
            except that it has the classification of the instance.
        :type instance: :ref:`Instance<instance-rep>`
        """
        self.count += 1
        for attr in instance:
    ...
    def create_new_child(self, instance, instance_with_c=None):
        ...
        :param instance: The instance currently being categorized
        :param instance_with_c: The same instance of the new one except it also has its classification.
        :type instance: :ref:`Instance<instance-rep>`
